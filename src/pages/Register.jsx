...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="absolute top-1/4 right-0 w-[600px] h-[600px] bg-indigo-600/10 rounded-full blur-[120px]" />

            <Card className="w-full max-w-md z-10">
                <div className="text-center mb-8">
                    <h2 className="heading-xl text-3xl mb-2">Create Account</h2>
                    <p className="text-muted">Join the fair resolution platform</p>
                </div>
